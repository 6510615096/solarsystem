...
SECRET_KEY = 'django-insecure-w(4ohueh%nbxk(c*xbrcu-lqpa=3c-w0ptbw*ll0s!2tmp7b&g'
...
LOGIN_REDIRECT_URL = 'solarapp:home'
LOGOUT_REDIRECT_URL = '/'
LOGOUT_URL = 'logout'
LOGIN_URL = 'login'
...
SOCIAL_AUTH_PIPELINE = [
    ...
    'solarapp.views.get_user_by_email_if_exists',
